...
From the previous knowledge, we know that the information matrix of parameter estimates is the inverse matrix of fisher information, and the values on the diagnol of the information matrix are the variance of parameter estimates.
```{r var}
vari <- solve(-M)
